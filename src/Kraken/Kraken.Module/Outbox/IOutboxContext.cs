...
/// de dominio y modulares que deben de ser distribuidos solo cuando 
...
public interface IOutboxContext
{
    ...
    /// </summary>
    IReadOnlyCollection<OutboxMessage> Events { get; }
    ...
    void AddProcessMessage(OutboxMessage @event);
