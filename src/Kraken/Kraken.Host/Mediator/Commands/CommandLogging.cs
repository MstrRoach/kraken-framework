...
namespace Kraken.Host.Mediator.Commands
{
    /// <summary>
    ...
    internal sealed class CommandLogging<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
        where TRequest : class, ICommand<TResponse>
    {

        private readonly ILogger<CommandLogging<TRequest, TResponse>> _logger;

        public CommandLogging(ILogger<CommandLogging<TRequest, TResponse>> logger)
        {
            _logger = logger;
        }
