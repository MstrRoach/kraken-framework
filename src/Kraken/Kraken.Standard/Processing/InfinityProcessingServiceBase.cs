...
namespace Kraken.Standard.Processing;

internal class InfinityProcessingServiceBase : IProcessingService
{
    /// <summary>
    ...
    public InfinityProcessingServiceBase(ILogger logger, string processName, 
        TimeSpan timeout)
    {
        _logger = logger;
